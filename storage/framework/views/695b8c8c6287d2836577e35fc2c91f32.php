...
<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
            <div class="aside-top" style="padding:0">
                <a href="<?php echo e(route('admin.index')); ?>" class="brand-wrap">
                    ...
                    <?php if($companySettings && $companySettings->logo): ?>
                        <img src="<?php echo e(asset('frontend/newstyle/assets/images/logo.png')); ?>" class="logo" alt="DK-Mart" style="margin-left:80%;"/>
                    <?php else: ?>
        ...
        </aside><?php /**PATH C:\Users\anura\Desktop\New folder (6)\DK-Mart-main1\resources\views/AdminDashboard/Sidebar.blade.php ENDPATH**/ ?>