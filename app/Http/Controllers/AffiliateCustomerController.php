...
class AffiliateCustomerController extends Controller
{
    ...
    {
        $aff_customer =  AffiliateUser::all();
    ...
    {
        $aff_customer = AffiliateUser::find($id);
    ...
    {
        $aff_customer = AffiliateUser::findOrFail($id);
    ...
    public function login(Request $request)
    {
        ...
        $customer = AffiliateUser::where('email', $request->email)->first();
