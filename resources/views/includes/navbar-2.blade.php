<style>
    .homepage-cart-position {
        position: relative;
        top: -15px;
        right: -10px;
        z-index: 1000;
    }
    .homepage-user-position {
...
{{-- mobile --}}
                                        <div class="profile-dropdown">
                                            @auth
                                                ...
                                                <div
                                                    class="log-user-img dropdown col-2-5 {{ request()->is('/') ? 'homepage-user-position' : '' }}">
                                                    <a href="#">
                                                        <img
                    ...
                    <div class="site-common-con header-search">
                        <div class="destop-main-header">
                            ...
                            <div class="header-right-con">
                                <div class="top-right-nav">
                                    <div
                                        class="des-cart pos-relative cart-popup {{ request()->is('/') ? 'homepage-cart-position' : '' }}">
