...
@section('content')
        ...
        <div class="container container-lg">
            <div class="flex-wrap gap-16 breadcrumb-wrapper flex-between">
                <ul class="flex-wrap gap-8 flex-align">
                    ...
                    <li class="text-sm text-main-600"> Home </li>
                </ul>
            </div>
        </div>
    </div> --}}
    ...
    <section class="relative bg-cover bg-center w-full flex items-top justify-center px-4 sm:px-6 py-20"
        ...
        {{-- <div class="md:relative z-10 text-white text-center"> --}}
    ...
    <!-- Palm Oil Banner -->
    {{-- <section class="relative bg-cover bg-center min-h-screen flex items-top justify-center px-4 sm:px-6"
